...
export default function Footer() {
  return (
    <>
      <footer
        className="bg-[#f5f4f4] mx-auto px-5 sm:px-20 pt-16 pb-12"
        id="contact"
      >
        <div className=" grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 sm:gap-16 gap-10">
          ...
          <div>
            ...
            <p className="text-lg font-medium mb-2">
              Trusted End-To-End Business Consultant in Pune For Your Business
              Success.
            </p>
          ...
          <div>
            ...
            <h3 className="text-2xl font-semibold text-[#E51D25] mt-6 mb-3">
              Branches
            </h3>
            <ul className="text-lg font-medium space-y-2">
              <li>• Pune</li>
            ...
            <div>
              ...
              <p className="text-lg font-medium mb-2">
                ...
                <span className="text-[16px] text-gray-800">
                  Office No 1, Savli Building, DP Rd, Hadapsar, Pune,
                  Maharashtra - 411028, India.
                </span>
              </p>
              <p className="text-lg font-medium mb-2">
                Phone:{" "}
                <span className="text-[16px] text-gray-800 hover:text-red-700">
                  <a href="tel:9610456254">+(91) 9610456254</a>
                </span>
              </p>
              <p className="text-lg font-medium">
                Email:{" "}
                <span className="text-[16px] text-gray-800 hover:text-red-700">
                  <a href="mailto:info@youtax.in">info@youtax.in</a>
                </span>
              </p>
            </div>
