...
export default function ServicesSection() {
  ...
  <div className="flex flex-col md:flex-row gap-8 text-left">
    ...
    <div className="md:w-[65%] p-5 sm:p-6">
       ...
       <div className="mb-6 text-center sm:text-start">
            ...
            Tired Of <br />
              <span className="text-[#E51D25]">Late Fees ? </span>
            </h2>
            ...
            <h2 className="text-[#E51D25] text-2xl font-semibold mt-4">Here’s how we help you:</h2>
  ...
  <div className="flex flex-col items-center text-center">
    ...
    <h3 className="text-[#E51D25] text-2xl font-semibold">Consult</h3>

    <span className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-full text-sm sm:text-base my-5">
      02
    </span>
    
    <h3 className="text-[#E51D25] text-2xl font-semibold">Document Collection</h3>

    <span className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-full text-sm sm:text-base my-5">
      03
    </span>
    
    <h3 className="text-[#E51D25] text-2xl font-semibold">Filing</h3>

    <span className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-full text-sm sm:text-base my-5">
      04
    </span>
    
    <h3 className="text-[#E51D25] text-2xl font-semibold">Delivery</h3>
  </div>
</div>
