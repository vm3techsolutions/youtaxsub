  ...
  return (
    <>
      <div className="relative mx-6 my-12 md:m-24">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Youtax India Consulting Pvt. Ltd..
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Youtax India Consulting Pvt.
              Ltd., accessible from{" "}
              <a
        ...
        <ul>
          <li>
            <p>By email: info@youtax.in</p>
          </li>
          <li>
            <p>By phone number: +(91) 9610456254</p>
          </li>
        </ul>
      </div>
    </>
